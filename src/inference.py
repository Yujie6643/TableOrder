...
from sft_minicpm_block_textmeta import (
...
MODEL_PATH = os.environ.get("MODEL_PATH", f"/data/tyj/2D-TPE-main/output/{DATASET_NAME}_{PATH_MODE_SUFFIX}")
INPUT_PATH = f"/data/tyj/2D-TPE-main/eval_data/{DATASET_NAME}_test.json"
DEFAULT_OUTPUT_PATH = (
    f"/data/tyj/2D-TPE-main/res/{DATASET_NAME}_{PATH_MODE_SUFFIX}_res.json"
    if TABLE_READ_MODE
    else f"/data/tyj/2D-TPE-main/res/{DATASET_NAME}_res.json"
)
